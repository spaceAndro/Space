...
cuisine_types = {
    ...
    "중식": ['오향장육', '깐풍기', '유린기', '탄탄멘', '쌀국수', '상하이볶음면', '월남쌈', '마파두부', '마파두부밥', '마라짬뽕', '짬짜면', '토마토 달걀 볶음', '오렌지 치킨', '사천식 양꼬치','짜장밥', '삼선짬뽕밥', '멘보샤', '양꼬치', '고추기름 닭고기', '마라탕', '마라샹궈', '소룡포', '북경오리', '유니짜장', '마파면', '훈툰', '깐쇼새우덮밥', '사천식 돼지고기 볶음', '라조기', '꿔바로우 샐러드', '건두부볶음', '마라양념탕수육', '해물볶음우동', '고추짬뽕', '군만두', '튀김만두', '깐쇼새우', '꿔바로우', '라면', '짬뽕', '짜장면', '탕수육', '중화비빔면', '사천식 닭 날개', '마라 샤브샤브'],
