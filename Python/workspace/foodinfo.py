...
food_categories = {
    ...
    "채소류": [
        "열무김치", "우거지국", "청포묵", "도토리묵무침", "미나리무침", "도라지무침",
        ...
        "버섯볶음", "트로피컬 샐러드", "오리엔탈 드레싱 샐러드", "로메인 샐러드",
        "파파야 샐러드", "샐러드", "새우 토스트", "수박 샐러드", "비트 샐러드",
    ...
    "감자류": [
        "뇨끼", "감자튀김", "감자 샐러드", "감자그라탕",
        "체다 치즈 튀김", "체다 치즈 칩", "허니 버터 칩",
    ...
    "대두류" :["두부김치", "마파두부", "건두부볶음", "두부조림"]
}

cuisine_types = {
    "한식": ['깻잎전', '오징어 튀김', '단호박튀김', '닭튀김', '동파육', '새우볶음밥', '참치볶음밥', '참치마요덮밥', '버섯국', '사골국', '참치국', '낙지국', '찐빵', '라볶이', '참치 비빔밥', '파전', '호박전', '갈매기살', '장어정식', '초벌 막창', '파삼겹', '해물된장찌개', '날치알 주먹밥', '무채 비빔국수', '숙성지 김치찌개', '우렁 된장찌개', '소갈비살', '항정살', '양갈비', '회냉면', '꽃목살', '유부 김밥', '고추참치 김밥', '깻잎 김밥', '날치알 김밥', '돈가스 김밥', '새우 김밥', '멸치 김밥', '계란 김밥', '소고기 김밥', '참치 김밥', '야채 김밥', '물막국수', '곱창전골', '소막창', '소대창', '소곱창', '순대국밥', '곱창볶음', '백합탕', '바지락 칼국수', '해물 수제비', '파김치장어전골', '해물 수제.비', '수제비', '철판 볶음밥', '비빔냉면', '두부전골', '잔치국수', '초계국수', '초계비빔국수', '오삼불고기 찌개', '황태찌개', '매운 갈비찜 찌개', '붕장어구이', '애호박찌개', '감자찌개', '차돌박이 된장찌개', '미역무침', '도라지무침', '연어구이', '방어구이', '명태구이', '전어구이', '도미구이', '가자미구이', '임연수구이', '삼치구이', '갈치구이', '낙지탕탕이', '시금치나물', '오징어채무침', '순대국', '불닭볶음면', '까르보나라 불닭볶음면', '후라이드 치킨', '동태찌개', '마파두부', '제육덮밥', '어묵볶음', '어묵탕', '고구마튀김', '새우완자', '유부 초밥', '돼지고기묵은지찜', '도토리묵무침', '순두부국', '대파무침', '닭강정', '매운돼지갈비', '콩국수', '청포묵', '배추겉절이', '미나리무침', '낙지볶음', '우렁강된장', '갈치조림', '돼지고기볶음', '시래기된장국', '소불고기', '치즈계란말이', '해물순두부찌개', '팥죽', '만두국', '수박 샐러드', '불고기 덮밥', '물김치', '생채', '전복죽', '감자전', '무국', '갈비구이', '고등어구이', '찜닭', '호박죽', '게장', '부추전', '무생채', '해물찜', '한치물회', '매운탕', '버섯볶음', '쫄면', '닭칼국수', '멍게무침', '미역국', '야채튀김', '두부김치', '오이무침', '꽁치조림', '홍합탕', '두부조림', '오이 샐러드', '미소 된장국', '조기구이', '닭봉구이', '장어구이', '계란찜', '비빔국수', '버섯 볶음밥', '낙지전골', '백숙', '고구마전', '곤약조림', '우엉조림', '산적', '떡갈비', '백김치', '고등어조림', '시금치 수프', '굴전', '콩나물무침', '소갈비찜', '새우젓 무침', '갈비탕', '애호박전', '돼지갈비', '계란국', '고추장찌개', '냉채족발', '계란말이', '김치찌개', '된장찌개', '제육볶음', '닭갈비', '감자탕', '김치볶음밥', '김치전', '떡국', '북엇국', '삼계탕', '설렁탕', '순대', '순두부찌개', '시래기국', '아귀찜', '열무김치', '오징어국', '오징어볶음', '육개장', '콩나물국', '해물탕', '해물파전', '가마솥밥', '갈비찜', '꼬막비빔밥', '굴밥', '물냉면', '닭볶음탕', '보쌈', '볶음밥', '불고기', '불닭', '전주비빔밥', '삼겹살', '소고기덮밥', '안동찜닭', '잡채밥', '잡채', '채소전', '족발', '김치볶음면', '떡볶이', '칼국수', '배추국', '보리밥', '김치국', '비지찌개', '오징어순대', '꽁치구이', '황태국', '육회', '오삼불고기', '해물라면', '부대찌개', '콩비지찌개', '청국장', '황태해장국', '매운갈비찜', '삼합', '쭈꾸미볶음', '우거지국', '떡만두국', '곰탕', '한우구이', '닭갈비 덮밥'],
    ...
    "양식": ['감자그라탕', '브로콜리 체다 수프', '아스파라거스 수프', '양송이 수프', '토마토 수프', '고로케', '치즈스틱', '라자냐', '감자튀김', '토마호크 스테이크', '리조또', '샌드위치', '버팔로 치킨 샌드위치', '크림통새우', '매콤로제파스타', '조개찜', '회덮밥', '포테이토베이컨 피자', '로제쉬림프', '알리오 올리오', '시금치 피자', '디아블로 피자', '마르게리타 피자', '샐러드 피자', '푸실리 파스타', '미트볼 파스타', '트러플 마카로니', '크림 바질 피자', '맥 앤 치즈', '와플 샌드위치', '투움바 파스타', '토마토 갈릭 파스타', '미니 햄버거', '치킨 너겟', '베이글 샌드위치', '햄 치즈 토스트', '바나나 브레드', '감자크림수프', '갈릭 토스트', '페스토 샌드위치', '바베큐 치킨', '토마토 리소토', '바베큐 치킨 피자', '라임 치킨', '체다 치즈 튀김', '토마토 모차렐라 피자', '브루스케타', '마늘빵', '크로크무슈', '레몬 치킨', '시나몬 롤', '로코모코', '체다 치즈 칩', '연어 파스타', '프레즐', '렌틸콩 샐러드', '양파 링', '아보카도 토스트', '코코아 머핀', '소시지 그라탱', '참치 니스와 샐러드', '돼지갈비 스튜', '연어 샌드위치', '크림치즈 파스타', '버팔로 치킨 샐러드', '새우 스캄피 파스타', '토마토 치즈 타르트', '감자 피자', '치즈 옥수수', '사우전 아일랜드 샐러드', '크림 치즈 베이글', '레몬 버터 새우', '그릴드 치즈 샌드위치', '레몬 허니 샐러드', '소이 글레이즈드 연어', '오리엔탈 드레싱 샐러드', '로메인 샐러드', '바질 페스토 샌드위치', '미트볼 파스타', '치킨 파마산', '스테이크 타르타르', '구운 감자 샐러드', '그릴드 연어', '바질페스토 피자', '할라피뇨 팝퍼', '비트 수프', '허니 버터 칩', '치킨 크림파스타', '랍스터 크림 스프', '비프 타르타르', '연어 머핀', '칠리 치즈 감자튀김', '갈릭 새우 파스타', '블랙 올리브 파스타', '살몬 크림 파스타', '크림치즈 베이글', '토마토 바질 스프', '새우 크림 리조또', '바질페스토 라비올리', '감바스 리조또', '토마토 브루스케타', '바베큐 폭립', '페퍼로니 피자', '비건 버거', '코코넛 치킨', '트러플 감자튀김', '사과 소스 포크', '트러플 리소토', '체다 감자 크림', '피자 토스트', '까르보나라 파스타', '바질페스토 파스타', '트러플 파스타', '비스크 수프', '푸아그라', '베이컨 에그 베네딕트', '스테이크', '피자', '샐러드', '크림수프', '라따뚜이', '비프 브루기뇽', '치킨 팟파이', '치즈버거', '클럽 샌드위치', '시저 치킨랩', '감바스 알 아히요', '크로켓', '필라프', '프렌치 어니언 수프', '바질 파스타', '살몬 아보카도 샐러드', '랍스터 비스크', '포크 롤', '미트로프', '햄버거', '피쉬 앤 칩스', '치킨 알프레도', '시저 샐러드', '블랙빈 수프', '파스타', '감자 샐러드', '포테이토 샐러드', '브런치 세트', '양송이 크림파스타', '클램 차우더', '닭다리 구이', '양고기 찹스', '닭가슴살 샐러드', '뇨끼', '오리 로스트', '크로와상 샌드위치', '새우 카레라이스', '닭가슴살 스테이크', '비트 샐러드', '코코넛 쉬림프', '양고기 스테이크', '치즈 감자튀김', '버섯 리소토', '베지터블 라자냐', '참치 샌드위치', '버팔로윙', '홍합찜', '랍스터 롤', '치킨 시저랩', '프렌치 토스트', '새우 크림 스튜'],
    "퓨전": ['브리또', '유산슬', '돈카츠 회오리 오므라이스', '연어 김밥', '베이컨 김밥', '명란 크림파스타', '애호박 라자냐', '타이 새우 볶음', '치즈 퀘사디아', '트로피컬 샐러드', '치킨 카레', '살사 치킨 타코', '참치 카나페', '샐러드롤', '새우 토스트', '파파야 샐러드', '닭가슴살 튀김', '새우구이', '타이 그린 카레', '스윗 칠리 새우', '불고기 타코', '카레', '베이컨 감자 샐러드', '호박 수프', '브로콜리 샐러드', '크림 시금치 파스타', '시저 파스타 샐러드', '쉬림프 타코', '파인애플 볶음밥', '치킨 필라프', '햄 치즈 파니니', '퀘사디아', '감바스 알 아히요', '부리또', '아란치니', '에그 베네딕트', '타코', '타이식 닭볶음', '하와이안 치킨 샐러드']
}
...
for i in range(1, num_samples + 1):
    ...
    if weather_condition in weather_weights:
        ...
        if random.random() < 0.7:  # 확률로 날씨와 관련된 음식을 선택
            food_name, ingredients = random.choice([(food, []) for food in weighted_foods])
        else:
            food_name, ingredients = random.choice(meal_food_names)
    else:
        food_name, ingredients = random.choice(meal_food_names)
